...
params.tmp_directory = '/home/ccconlin/tmp_pro_ignite';
...
params.container = 'singularity';

% Path to configuration file for RSI processing
params.rsi_config_file = '/home/ccconlin/apps/pro-ignite/config_rsi.m'; 

% Path to configuration file for DICOM networking
params.routing_config_file = '/home/ccconlin/apps/pro-ignite/config_routing.m';
